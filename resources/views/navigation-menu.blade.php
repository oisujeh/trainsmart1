                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <x-jet-dropdown align="center" width="60">
                                    ...
                                    <x-slot name="content">
                                        <div class="w-60">
                                            <x-jet-dropdown-link href="{{ url('/titles') }}">
                                                {{ __('Training Title') }}
                                            </x-jet-dropdown-link>
                            ...
                            <div class="ml-3 relative">
                                <x-jet-dropdown align="center" width="60">
                                    ...
                                    <x-slot name="content">
                                        <div class="w-60">
                                            <x-jet-dropdown-link href="{{ url('/reports/trainings_by_participants') }}">
                                                {{ __('Trainings Done') }}
                                            </x-jet-dropdown-link>
                                            {{--<div class="border-t border-gray-100"></div>
                    ...
                    <div class="ml-3 relative">
                        <x-jet-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:bg-green-200 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition">
                                                Administration
                                                <svg class="ml-2 -mr-0.5 h-4 w-4" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd"
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    <!-- Role Settings -->
                                    <x-jet-dropdown-link href="/roles">
                                        {{ __('Role Settings') }}
                                    </x-jet-dropdown-link>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <!-- Team Settings -->
                    <x-jet-responsive-nav-link href="/roles">
                        {{ __('Roles') }}
                    </x-jet-responsive-nav-link>
